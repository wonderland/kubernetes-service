...
Kubectl is the command line interface for interacting with a Kubernetes cluster. The kubectl tool lets you connect and run commands against your https://nks.netapp.io[NetApp Kubernetes Service (NKS)] cluster.
