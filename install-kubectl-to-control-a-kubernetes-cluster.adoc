...
In a web browser, log in to NKS. Click on your cluster to view the details. Download your cluster’s `kubeconfig` file from the menu on the left-hand side of the screen.
...
In a web browser, log in to NKS. Click on your cluster to view the details. Download your cluster’s `kubeconfig` file from the menu on the left-hand side of the screen. Upload the file to the server. Then update your shell environment to call the file:
