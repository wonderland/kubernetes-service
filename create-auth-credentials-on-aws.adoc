...
image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/click-services.png?raw=true[AWS Auth: Click Services]

In the **Security, Identity & Compliance** column, click **IAM**.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/click-iam.png?raw=true[AWS Auth: Click IAM]

Click **Users**.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/click-users.png?raw=true[AWS Auth: Click Users]

Click **Add User**.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/click-add-user.png?raw=true[AWS Auth: Click Add Users]
...
image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/select-access-type.png?raw=true[AWS Auth: Select Access Type]
...
image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/set-permissions.png?raw=true[AWS Auth: Set Permissions]
...
image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/create-group.png?raw=true[AWS Auth: Create Group]

Confirm the new user's information, then click **Create user** to create the user.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/confirm-user.png?raw=true[AWS Auth: Confirm User]

Click **Download .csv** and save the user's security credentials to your computer.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/download-csv.png?raw=true[AWS Auth: Download CSV]
...
image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/attach-existing-policy.png?raw=true[AWS Auth: Attach Existing Policies]

Click **Create Policy**.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/click-create-policy.png?raw=true[AWS Auth: Click Create Policy]

Click to select **Create Your Own Policy**.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/create-your-own-policy.png?raw=true[AWS Auth: Create Your Own Policy]
...
image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/return-to-users-page.png?raw=true[AWS Auth: Return to Users Page]

Click your user account to go to the user management page.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/return-to-user-management-page.png?raw=true[AWS Auth: Return to User Management Page]

Click the **Permissions** tab, then click **Attach Policy**.

image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/permissions-attach-policy.png?raw=true[AWS Auth: Attach Policy]
...
image::https://github.com/NetAppDocs/kubernetes-service/blob/master/assets/documentation/create-auth-credentials-on-aws/attach-policy.png?raw=true[AWS Auth: Attach the Policy]
