...
https://nks.netapp.io[NetApp Kubernetes Service (NKS)] must be set up to manage a project within your Google Compute Engine (GCE) account. To do this, log into the Google cloud console at https://console.cloud.google.com.
