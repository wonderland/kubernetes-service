...
After you create your Istio mesh, https://docs.netapp.com/us-en/kubernetes-service/istio-test-cross-cluster-mesh.html[click here to learn how to deploy a demo to test the cross-cluster mesh].
