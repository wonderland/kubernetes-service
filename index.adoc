...
Projects let you organize workloads and simplify deployment. Each Project is assigned to a single Workspace. Projects can have multiple cluster and any combination of Solutions (including Applications, Trackers, and Packages).
